...
function videoHeight() {
	...
	var innerwidth = $('.vjs-tech').width();
	var height=$('.vjs-tech').height();
	if (outwidth < (innerwidth+30)) {
		myPlayer.height((outwidth-30) / myPlayer.getProportion);
	} else {
...
function resizeVideo () {
	//获取视屏宽高比函数
	myPlayer.getProportion=($('.video-js').width()/myPlayer.height());
	//浏览器宽度
